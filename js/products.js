...
(function () {
  ...
  window.HINOKA_PRODUCTS = [
    ...
    {id:'B001',name:'プロ用ラベルプリンター',price:12800,
     ...
     images:imgs('b001'),colors:['#2c2c2c'],sizes:['FREE'],stock:15,moq:1,
    ...
    {id:'B002',name:'ラベルシール A4 100枚入',price:980,
     category:'office-supplies',parentCat:'for-business',
     images:imgs('b002'),colors:['#ffffff'],sizes:['A4'],stock:200,moq:5,
    ...
    {id:'B003',name:'A4ファイル 10冊セット',price:2200,
     category:'office-supplies',parentCat:'for-business',
     images:imgs('b003'),colors:['#1a3a6b','#8b0000','#2c5f2e'],sizes:['FREE'],stock:50,moq:1,
     desc:'耐久性の高いポリプロピレン製ファイル。見出しラベル付き、大容量収納可能。',
     specs:'サイズ：A4 / 背幅：約30mm / 材質：PP / セット内容：10冊'},

    {id:'B004',name:'ジェルボールペン 12本セット',price:1480,
     category:'office-supplies',parentCat:'for-business',
     images:imgs('b004'),colors:['#000000','#1a3a6b','#8b0000'],sizes:['0.5mm'],stock:100,moq:1,
    ...
    {id:'B007',name:'付箋セット 6色 600枚',price:880,
     category:'office-supplies',parentCat:'for-business',
     images:imgs('b007'),colors:['#f6c90e','#ff7070','#69d2e7','#a8e6a3','#ffb347','#d4b0ff'],sizes:['FREE'],stock:150,moq:2,
     desc:'鮮やかな6色セット。くり返し貼れる弱粘着タイプ。ページ仕分けや備忘録に。',
     specs:'サイズ：75×75mm / 枚数：各100枚（計600枚）/ 粘着：弱粘着 / 色：6色'},

    {id:'B008',name:'ホッチキス＋針セット',price:1650,
     category:'office-supplies',parentCat:'for-business',
     images:imgs('b008'),colors:['#2c2c2c'],sizes:['FREE'],stock:60,moq:1,
    ...
    {id:'B020',name:'宅配ビニール袋 100枚',price:1320,
     category:'packaging',parentCat:'for-business',
     images:imgs('b020'),colors:['#f5f5f5'],sizes:['A4','B4','A3'],stock:120,moq:5,
    ...
    {id:'B021',name:'プロ用工具セット 47点',price:18700,
     ...
     images:imgs('b021'),colors:['#8b0000'],sizes:['FREE'],stock:10,moq:1,
    ...
    {id:'B022',name:'電子部品アソートセット',price:5500,
     category:'industrial',parentCat:'for-business',
     images:imgs('b022'),colors:['#2c2c2c'],sizes:['FREE'],stock:30,moq:1,
    ...
    {id:'B027',name:'充電式電動ドライバー',price:9900,
     category:'industrial',parentCat:'for-business',
     images:imgs('b027'),colors:['#1a3a6b'],sizes:['FREE'],stock:15,moq:1,
    ...
    {id:'B028',name:'コンベックス スタンダード 5.5m',price:1540,
     category:'industrial',parentCat:'for-business',
     images:imgs('b028'),colors:['#f6c90e'],sizes:['FREE'],stock:60,moq:1,
     desc:'プロ仕様の巻き尺。ゆっくり戻る安全機構付き。',
     specs:'測定範囲：5.5m / テープ幅：19mm / 目盛：mm・cm / ケース：ABS樹脂'},

    {id:'B029',name:'デジタル水平器',price:4400,
     category:'industrial',parentCat:'for-business',
     images:imgs('b029'),colors:['#f6c90e'],sizes:['FREE'],stock:20,moq:1,
     desc:'角度・傾斜を数値で確認できるデジタル水平器。建築・設備工事に。',
     specs:'測定範囲：0-360° / 精度：±0.1° / 表示：LCD / 防水：IP54 / サイズ：230mm'},

    {id:'B030',name:'工場備品管理キット',price:7700,
     category:'industrial',parentCat:'for-business',
     images:imgs('b030'),colors:['#2c2c2c'],sizes:['FREE'],stock:12,moq:1,
    ...
    {id:'L001',name:'天然竹製 収納ボックス 3点セット',price:5500,
     ...
     images:imgs('l001'),colors:['#d4b896'],sizes:['FREE'],stock:25,moq:1,
    ...
    {id:'L002',name:'スチール ハンガーラック 幅90cm',price:8800,
     category:'home-living',parentCat:'for-life',
     images:imgs('l002'),colors:['#2c2c2c','#f5f5f5'],sizes:['FREE'],stock:15,moq:1,
    ...
    {id:'L003',name:'コードレス掃除機 軽量2.1kg',price:29800,
     category:'home-living',parentCat:'for-life',
     images:imgs('l003'),colors:['#f5f5f5','#2c2c2c'],sizes:['FREE'],stock:8,moq:1,
    ...
    {id:'L004',name:'マイクロファイバー モップセット',price:3300,
     category:'home-living',parentCat:'for-life',
     images:imgs('l004'),colors:['#f5f5f5'],sizes:['FREE'],stock:40,moq:1,
    ...
    {id:'L005',name:'ラタン 収納バスケット 3点セット',price:7700,
     category:'home-living',parentCat:'for-life',
     images:imgs('l005'),colors:['#d4b896'],sizes:['FREE'],stock:20,moq:1,
    ...
    {id:'L006',name:'ポスターフレーム A2 ブラック',price:4400,
     category:'home-living',parentCat:'for-life',
     images:imgs('l006'),colors:['#2c2c2c','#f5f5f5'],sizes:['A2','A3'],stock:35,moq:1,
    ...
    {id:'L007',name:'ソイ アロマキャンドル 3点セット',price:5500,
     category:'home-living',parentCat:'for-life',
     images:imgs('l007'),colors:['#f5f0e8'],sizes:['FREE'],stock:30,moq:1,
    ...
    {id:'L008',name:'ベルギーリネン カーテン 2枚組',price:12100,
     category:'home-living',parentCat:'for-life',
     images:imgs('l008'),colors:['#f5f0e8','#d4b896','#808080'],sizes:['100×178cm','100×200cm','100×240cm'],stock:18,moq:1,
    ...
    {id:'L009',name:'ウォールミラー 丸型 60cm',price:9900,
     category:'home-living',parentCat:'for-life',
     images:imgs('l009'),colors:['#2c2c2c','#d4b896'],sizes:['FREE'],stock:12,moq:1,
     desc:'直径60cmの大きめウォールミラー。ゴールドフレームが空間をエレガントに。',
     specs:'直径：600mm / フレーム：スチール（ゴールドまたはブラック）/ 壁掛け金具付属'},

    {id:'L010',name:'天然木 壁掛け時計',price:7700,
     category:'home-living',parentCat:'for-life',
     images:imgs('l010'),colors:['#d4b896'],sizes:['FREE'],stock:22,moq:1,
    ...
    {id:'L011',name:'耐熱ガラス保存容器 6点セット',price:6600,
     ...
     images:imgs('l011'),colors:['#f5f5f5'],sizes:['FREE'],stock:30,moq:1,
    ...
    {id:'L012',name:'ステンレス 調理器具セット 8点',price:8800,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l012'),colors:['#c0c0c0'],sizes:['FREE'],stock:20,moq:1,
    ...
    {id:'L013',name:'伸縮式 キッチン収納ラック',price:5500,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l013'),colors:['#c0c0c0'],sizes:['FREE'],stock:25,moq:1,
    ...
    {id:'L014',name:'天然竹製 まな板 大・中 2枚組',price:4400,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l014'),colors:['#d4b896'],sizes:['FREE'],stock:35,moq:1,
    ...
    {id:'L015',name:'鋳鉄ホーロー鍋 22cm',price:18700,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l015'),colors:['#8b0000','#2c2c2c','#f5f0e8'],sizes:['20cm','22cm','24cm'],stock:10,moq:1,
    ...
    {id:'L016',name:'白磁 食器セット 4人用',price:14300,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l016'),colors:['#f5f5f5'],sizes:['FREE'],stock:12,moq:1,
    ...
    {id:'L017',name:'セルロース スポンジ 6個セット',price:1540,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l017'),colors:['#f6c90e','#ff7070','#69d2e7'],sizes:['FREE'],stock:100,moq:2,
    ...
    {id:'L018',name:'ステンレス 水切りラック',price:6600,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l018'),colors:['#c0c0c0'],sizes:['FREE'],stock:20,moq:1,
    ...
    {id:'L019',name:'回転 調味料ラック 5連',price:3850,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l019'),colors:['#c0c0c0'],sizes:['FREE'],stock:28,moq:1,
    ...
    {id:'L020',name:'シリコン ヘラ＆スパチュラ 6点セット',price:2860,
     category:'kitchen',parentCat:'for-life',
     images:imgs('l020'),colors:['#ff7070','#f5f0e8'],sizes:['FREE'],stock:45,moq:1,
    ...
    {id:'L029',name:'LED ランタン 充電式',price:5500,
     category:'travel-outdoor',parentCat:'for-life',
     images:imgs('l029'),colors:['#2c2c2c','#f5f0e8'],sizes:['FREE'],stock:25,moq:1,
    ...
    {id:'L030',name:'真空断熱 ウォーターボトル 1L',price:4400,
     category:'travel-outdoor',parentCat:'for-life',
     images:imgs('l030'),colors:['#c0c0c0','#2c2c2c','#1a3a6b','#8b0000'],sizes:['FREE'],stock:35,moq:1,
