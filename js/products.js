...
(function () {
  ...
  window.HINOKA_PRODUCTS = [
    ...
    {id:'P001',name:'ホリスティック ドッグフード 3kg',price:5500,
     ...
     images:['assets/images/soldout.jpg'],colors:['#d4b896'],sizes:['3kg','6kg'],stock:0,moq:1,
    ...
    {id:'P002',name:'メモリーフォーム ドッグベッド M',price:9900,
     category:'dog',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#d4b896','#808080'],sizes:['S','M','L'],stock:0,moq:1,
    ...
    {id:'P003',name:'本革 ハーネス＆リードセット',price:8800,
     category:'dog',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#8b4513','#2c2c2c'],sizes:['S','M','L'],stock:0,moq:1,
    ...
    {id:'P005',name:'インタラクティブ おもちゃ 5点セット',price:4400,
     category:'dog',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#ff7f00'],sizes:['FREE'],stock:0,moq:1,
    ...
    {id:'P007',name:'チキン風味 犬用おやつ 200g',price:1540,
     category:'dog',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#d4b896'],sizes:['FREE'],stock:0,moq:2,
    ...
    {id:'P008',name:'充電式 電動ネイルグラインダー',price:4950,
     category:'dog',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#f5f5f5','#ff7070'],sizes:['FREE'],stock:0,moq:1,
     ...
     sizes:['S','M','L','XL','XXL'],
     priceBySize:{S:3455,M:3665,L:3880,XL:4090,XXL:4300},
     stock:200, moq:5,
     desc:'ラブラドールを含む大型犬専用の透明四脚防水レインコート。防雨・透気・快適設計。お腹まで完全カバー。OEM対応可。',
     specsList:[
       ['素材','ポリエステル100%'],
       ['カラー','ブラック / ピンク / イエロー / ブルー'],
       ['OEM','対応可'],
       ['産地','中国']
     ],
     sizeChart:{
       headers:['サイズ','背長(cm)','胸囲(cm)','重量(g)','包装サイズ(cm)'],
       rows:[
         ['S','20','36','57','18×19×1'],
         ['M','25','42','69','19×21×1'],
         ['L','30','48','87','22×24×1'],
         ['XL','35','54','105','23×27×1'],
         ['XXL','40','60','108','23×30×1']
       ]
     },
     delivery:'通常3〜7営業日以内に発送',
     returns:'商品到着後7日以内、未使用品に限り返品可'},
    ...
    colorOptions:[
     ...
     colors:['#808080','#8b4513'],
     sizes:['28×51×39cm'],
     stock:100, moq:5,
     desc:'ペット用外出・機内持込対応キャリーバッグ。人間工学に基づいた背負いシステム、防雨設計、大容量、多収納、3面通気、折りたたみ収納対応。OEM対応可。',
     specsList:[
       ['素材','ポリエステル100%'],
       ['サイズ','28×51×39cm（耐荷重15kgまで）'],
       ['自重','2.2kg'],
       ['対応犬種','コーギー、フレンチブルドッグ、ダックスフンドなど'],
       ['カラー','グレー / ブラウン'],
       ['特長','防雨・大容量・3面通気・折りたたみ収納'],
       ['OEM','対応可'],
       ['産地','中国']
     ],
     delivery:'通常3〜7営業日以内に発送',
    ...
    {id:'P011',name:'グレインフリー キャットフード 2kg',price:4400,
     ...
     images:['assets/images/soldout.jpg'],colors:['#d4b896'],sizes:['2kg','4kg'],stock:0,moq:1,
    ...
    {id:'P012',name:'麻縄巻き キャットタワー 160cm',price:22000,
     category:'cat',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#d4b896','#808080'],sizes:['FREE'],stock:0,moq:1,
    ...
    {id:'P015',name:'陶器 猫用食器セット 2点',price:4400,
     category:'cat',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#f5f5f5','#d4b896'],sizes:['FREE'],stock:0,moq:1,
     desc:'ヒゲが当たらない浅型デザインの陶器製猫用食器。洗いやすく衛生的。',
     specs:'素材：陶器 / 直径：各160mm / 深さ：40mm / 電子レンジ可 / 食洗機可'},

    {id:'P016',name:'天然鉱物 猫砂 10L',price:2200,
     category:'cat',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#f5f5f5'],sizes:['10L','20L'],stock:0,moq:2,
    ...
    {id:'P019',name:'まぐろ風味 猫用おやつ 60g',price:880,
     category:'cat',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#ff7f00'],sizes:['FREE'],stock:0,moq:3,
    ...
    {id:'P025',name:'天然成分 消臭スプレー 500ml',price:2200,
     category:'pet-care',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#f5f0e8'],sizes:['FREE'],stock:0,moq:2,
    ...
    {id:'P026',name:'ペット用 厚手ウェットシート 80枚',price:1540,
     category:'pet-care',parentCat:'pet',
     images:['assets/images/soldout.jpg'],colors:['#f5f5f5'],sizes:['FREE'],stock:0,moq:3,
    ...
    // ── Pet — Toys / おもちゃ ──
     ...
     colorOptions:[
       {name:'クリスマスディア',  hex:'#8b5e3c', imgIndex:0},
       {name:'サンタクロース',    hex:'#cc2200', imgIndex:2},
       {name:'スノーマン',        hex:'#f5f5f5', imgIndex:4}
     ],
     colors:['#8b5e3c','#cc2200','#f5f5f5'],
     sizes:['21cm（ディア）','27.5cm（サンタ）','26cm（スノーマン）'],
     stock:50, moq:1,
     desc:'灯芯绒（コーデュロイ）素材の可愛いクリスマスキャラクター犬用ロープトイ。内置発声器付きで遊びが広がります。耐噛み・耐引き裂き設計。OEM対応可。',
     specsList:[
       ['素材','コーデュロイ / ナイロン'],
       ['款式','クリスマスディア（21cm）/ サンタクロース（27.5cm）/ スノーマン（26cm）'],
       ['幅','7.5cm（全款共通）'],
       ['重量','約50g'],
       ['包装','OPP袋独立包装'],
       ['入数','150個/箱'],
     ...
     moqNote:'1箱（150個）単位での販売',
     delivery:'通常3〜7営業日以内に発送',
     returns:'商品到着後7日以内、未使用品に限り返品可'},

        {id:'P032',name:'コーデュロイ 腹ばい動物 ペットぬいぐるみ（3種）',price:119040,
     category:'pet-toys',parentCat:'pet',
     images:['assets/images/p032_1.jpg','assets/images/p032_2.jpg','assets/images/p032_3.jpg','assets/images/p032_4.jpg','assets/images/p032_5.jpg','assets/images/p032_6.jpg','assets/images/p032_7.jpg','assets/images/p032_8.jpg','assets/images/p032_9.jpg'],
     colorOptions:[
       {name:'グリーン', hex:'#3a7a3a', imgIndex:0},
       {name:'レッド',   hex:'#cc2200', imgIndex:3},
       {name:'オレンジ', hex:'#ff7f00', imgIndex:6}
     ],
     colors:['#3a7a3a','#cc2200','#ff7f00'],
     sizes:['24×14cm'],
     stock:50, moq:1,
     desc:'コーデュロイ素材の腹ばい動物形ペットぬいぐるみ。頭部内置発声器付き。耐噛み・耐引き裂き、洗っても毛が落ちない高品質素材。OEM対応可。',
     specsList:[
       ['素材','コーデュロイ'],
       ['種類','3種（グリーン / レッド / オレンジ）'],
       ['サイズ','24×14cm'],
       ['重量','36g'],
       ['特長','頭部発声器内蔵・耐噛み・耐引裂・水洗可'],
       ['入数','96個/箱'],
       ['価格','¥119,040/箱'],
       ['OEM','対応可'],
       ['産地','中国']
     ],
     moqNote:'1箱（96個）単位での販売',
     delivery:'通常3〜7営業日以内に発送',
     returns:'商品到着後7日以内、未使用品に限り返品可'},

        {id:'P033',name:'コーデュロイ インタラクティブ ぬいぐるみトイ（3種）',price:276000,
     category:'pet-toys',parentCat:'pet',
     images:['assets/images/p033_1.jpg','assets/images/p033_2.jpg','assets/images/p033_3.jpg','assets/images/p033_4.jpg','assets/images/p033_5.jpg'],
     colorOptions:[
       {name:'クマ', hex:'#8b5e3c', imgIndex:0},
       {name:'ウシ', hex:'#f5f5f5', imgIndex:2},
       {name:'サル', hex:'#d4870a', imgIndex:4}
     ],
     colors:['#8b5e3c','#f5f5f5','#d4870a'],
     sizes:['28×32cm'],
     stock:50, moq:1,
     desc:'コーデュロイ素材の動物形インタラクティブぬいぐるみ。発声器・動くノット付きで遊び方が豊富。ストレス解消・歯磨き・トレーニングに最適。OEM対応可。',
     specsList:[
       ['素材','コーデュロイ / ゴム'],
       ['種類','3種（クマ / ウシ / サル）'],
       ['サイズ','28×32cm'],
       ['重量','58g'],
       ['包装','OPP袋独立包装'],
       ['特長','発声器内蔵・動くノット・耐噛み・耐引裂'],
       ['入数','200個/箱'],
       ['価格','¥276,000/箱'],
       ['OEM','対応可'],
       ['産地','中国']
     ],
     moqNote:'1箱（200個）単位での販売',
     delivery:'通常3〜7営業日以内に発送',
     returns:'商品到着後7日以内、未使用品に限り返品可'},
